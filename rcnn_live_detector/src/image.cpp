...
void SearchQR (const std_msgs::String::ConstPtr& messageObject)
{
	...
	cv::Mat image = ptrGuardarRGBInicio->image;
...
int main(int argc, char **argv)
{
  ...
  ros::init(argc, argv, "SearchBase");
  ROS_INFO("inicio de nodo SearchBase");
  nh_ptr_ = boost::make_shared<ros::NodeHandle>();



  //Suscribirse al reconocimiento de voz
  searchQR_sub = nh_ptr_->subscribe<std_msgs::String>("/searchQRtopic", 1000, SearchQR);
